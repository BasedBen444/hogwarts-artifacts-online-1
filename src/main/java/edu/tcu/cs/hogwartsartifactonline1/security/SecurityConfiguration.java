...
import edu.tcu.cs.hogwartsartifactonline1.hogwartsuser.UserRepository;
...
public class SecurityConfiguration {
    ...
    public JwtEncoder jwtEncoder() {
        ...
        JWKSource<SecurityContext> jwkSet = new ImmutableJWKSet<SecurityContext>(new JWKSet(jwk));
